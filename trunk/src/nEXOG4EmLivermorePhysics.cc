...
// ********************************************************************
//
// $Id: nEXOG4EmLivermorePhysics.cc 79157 2014-02-19 15:35:01Z gcosmo $
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(nEXOG4EmLivermorePhysics);


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

nEXOG4EmLivermorePhysics::nEXOG4EmLivermorePhysics(G4int ver)
  : G4VPhysicsConstructor("nEXOG4EmLivermorePhysics"), verbose(ver)
{
...
nEXOG4EmLivermorePhysics::nEXOG4EmLivermorePhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("nEXOG4EmLivermorePhysics"), verbose(ver)
{
  G4LossTableManager::Instance();
  SetPhysicsType(bElectromagnetic);
...
nEXOG4EmLivermorePhysics::~nEXOG4EmLivermorePhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void nEXOG4EmLivermorePhysics::ConstructParticle()
{
// gamma
  G4Gamma::Gamma();
...
void nEXOG4EmLivermorePhysics::ConstructProcess()
{
  if(verbose > 1) {
