...
private:
  ...
  G4double fTPCRadius;
  G4double fTPCHalfheight;
  G4double fTPCVesselSideThickness;
  G4double fTPCVesselEndCapThickness;
  ...
  G4double fChargeModuleGlueThickness;
  G4double fChargeModuleGlueRadius;
  G4double fChargeModuleGluePosition;
  G4double fChargeModuleChipLength;
  G4double fChargeModuleChipThickness;
  G4double fChargeModuleChipPosition;
  G4double fChargeModuleSupportThickness;
  G4double fChargeModuleSupportWidth;
  ...
  G4double fSTPCVesselEndCapThickness;
