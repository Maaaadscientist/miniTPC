...
#FieldRing TPC TReflector APDPlatter KCables TeflonInsulator FieldSupport
do 
...
bsub -q xlong ~/geant4/bin/Linux-g++/CoppernEXO $EXODIR/tesjohns/ClusteringAlgorithm/${type}-${iso}-${piece}-${date}-${i}.mac $i
