#ifndef nEXOG4S1Light_h
#define nEXOG4S1Light_h 1
...
class nEXOG4S1Light : public G4VRestDiscreteProcess //class definition
{
  // Class inherits publicly from G4VRestDiscreteProcess
private:
public: // constructor and destructor

        nEXOG4S1Light(const G4String& processName = "S1",
...
////////////////////
inline 
G4bool nEXOG4S1Light::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void nEXOG4S1Light::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool nEXOG4S1Light::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void nEXOG4S1Light::SetScintillationYieldFactor(const G4double yieldfactor)
{
  YieldFactor = yieldfactor;
}

inline
G4double nEXOG4S1Light::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline
void nEXOG4S1Light::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double nEXOG4S1Light::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

#endif /* nEXOG4S1Light_h */
