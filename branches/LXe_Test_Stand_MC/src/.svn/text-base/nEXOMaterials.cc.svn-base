...
void nEXOMaterials::AddMatProperties() {
  ...
  {
    fPhotonEnergies[i] = (4.13566743E-15*299792458/(fPhotonWavelengths[i]*1.E-9))*eV;
  }
  ...
  fLXeMat->AddConstProperty( "ELECTRICFIELD", 750.0*volt/cm ); //for missed nooks and crannies
