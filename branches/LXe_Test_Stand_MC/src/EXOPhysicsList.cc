...
EXOPhysicsListMessenger::EXOPhysicsListMessenger(EXOPhysicsList* physList)
{
  ...
  fDefaultCutValueCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
  ...
  fCutValueInnerRegionCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
  ...
  fCutValueInsideTPCCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
...
EXOPhysicsList::EXOPhysicsList() : G4VModularPhysicsList()
{
  ...
  fMessenger = new EXOPhysicsListMessenger(this);
    ...
    cutInsideTPC     = 100.0*nm;//1.0*mm;//100.0*nm;
