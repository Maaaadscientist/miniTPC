...
// ********************************************************************
//
#ifndef nEXOAnalysisManager_h
#define nEXOAnalysisManager_h 1

//---------------------------------------------------------------------------
//
// ClassName:   nEXOAnalysisManager
//
...
//              EXOAnalysisManager::GetInstance() static method.
...
class nEXOAnalysisManager
{

public:
  // With description

  static nEXOAnalysisManager* getInstance();
  static void dispose();
...
public: // Without description
  ...
  void AddParticle();
  void AddIsotope();
  void AddEnergy(G4double, G4double, G4double, G4int, G4int);
...
private:
  ...
  // MEMBERS
  static nEXOAnalysisManager* fManager;
  ...
  std::vector <nEXOEnergyDeposition> Edepo;
  //
  nEXOHisto*  histo;
