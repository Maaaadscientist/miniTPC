////////////////////////////////////////////////////////
// nEXODetectorConstruction1.hh
// Coarse nEXO Geometry header file
////////////////////////////////////////////////////////

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
#ifndef nEXODetectorConstruction1_h
#define nEXODetectorConstruction1_h 1
...
class EXODetectorMessenger1;
class G4Region;
class G4IStore;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

class nEXODetectorConstruction1 : public G4VUserDetectorConstruction
{
public:
  nEXODetectorConstruction1();
 ~nEXODetectorConstruction1();
...
private:
  ...
  G4double           HDPETankh;
  G4double           HDPETankTopOR;
  G4double           HDPETankTopIR;
  G4double           HDPETankToph;
  ...
  G4double           SSupport1PlaceZ;
  G4double           SSupport2PlaceZ;
  G4double           LeadPlatePlaceZ;
  G4double           HDPETankTopPlaceZ;
  G4double           AirCavityPlaceZ;
  ...
  G4Tubs*            solidHDPETankTop;
  G4LogicalVolume*   logicHDPETankTop;
  G4VPhysicalVolume* physiHDPETankTop;

  G4Tubs*            solidInnerWater;
  G4LogicalVolume*   logicInnerWater;
  G4VPhysicalVolume* physiInnerWater; 

  G4Tubs*            solidStSupport1;
  G4LogicalVolume*   logicStSupport1;
  G4VPhysicalVolume* physiStSupport1[2];
  ...
  G4Tubs*            solidLeadPlate;
  G4LogicalVolume*   logicLeadPlate;
  G4VPhysicalVolume* physiLeadPlate; 

  G4Tubs*            solidAirCavity;
  G4LogicalVolume*   logicAirCavity;
  G4VPhysicalVolume* physiAirCavity; 
  ...
  nEXODetectorMessenger1* detectorMessenger1;  //pointer to the Messenger
