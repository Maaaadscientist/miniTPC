...
#include "nEXODetectorConstruction3.hh"
#include "nEXODetectorMessenger3.hh"
...
nEXODetectorConstruction3::nEXODetectorConstruction3()  
{
//materials
defaultMaterial=0,
//objects
 ...
 solidActiveXe=0; logicActiveXe=0; physiActiveXe=0;
  ...
  //Outer Ti Vessel
  OuterCryoOR = 138.6*cm;     
  OuterCryoThick = 1.225*cm;           // Full Thickness = 2.45 cm
  OuterCryoH = 138.6*cm;               // Full Height = 260.2 cm
  ...
  InnerCryoThick = 1.225*cm;                       // Full thickness 2.45 cm
  ...
  APDPlatterR = InactiveXeR-0.4*cm;
  ...
  detectorMessenger = new nEXODetectorMessenger3(this);
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VPhysicalVolume* nEXODetectorConstruction3::Construct()
{
  return ConstructDetector();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void nEXODetectorConstruction3::DefineMaterials()
{
...
G4VPhysicalVolume* nEXODetectorConstruction3::ConstructDetector()
{
  //Clean old geometry
...
//Attributes of the Active LXe
  G4VisAttributes *AXeAtt = new G4VisAttributes(G4Colour(0.0, 0.0, 1.0));
...
void nEXODetectorConstruction3::UpdateGeometry()
{
