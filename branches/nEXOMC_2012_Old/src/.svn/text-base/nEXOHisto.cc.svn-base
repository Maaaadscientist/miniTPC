...
//#endif
  ...
  messenger = new nEXOHistoMessenger(this);
}
...
{
/*#ifdef G4ANALYSIS_USE
  G4cout << "### EXOHisto books " << nHisto << " histograms " << G4endl; 
...
void nEXOHisto::add1D(const G4String& id, const G4String& name, G4int nb, 
...
void nEXOHisto::setHisto1D(G4int i, G4int nb, G4double x1, G4double x2, G4double u)
{
  if(i>=0 && i<nHisto) {
    if(verbose > 0) {
    ...
    G4cout << "nEXOHisto::setEXOHisto1D: WARNING! wrong histogram index " << i << G4endl;
  }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void nEXOHisto::fillHisto(G4int i, G4double x, G4double w)
{
  if(verbose > 1) {
  ...
  if(i>=0 && i<nHisto) {
    ...
    G4cout << "nEXOHisto::fill: WARNING! wrong ROOT histogram index " << i << G4endl;
  }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void nEXOHisto::scaleHisto(G4int i, G4double x)
{
  if(verbose > 0) {
  ...
  if(i>=0 && i<nHisto) {
    ...
    G4cout << "nEXOHisto::scale: WARNING! wrong ROOT histogram index " << i << G4endl;
  }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void nEXOHisto::addTuple(const G4String& w1, const G4String& w2, const G4String& w3)
...
void nEXOHisto::fillTuple(G4int i, const G4String& parname, G4double x)
{
  if(verbose > 1) 
    G4cout << "fill tuple # " << i 
...
void nEXOHisto::fillTuple(G4int i, G4int col, G4double x)
{
  if(verbose > 1) {
    G4cout << "fill tuple # " << i 
...
void nEXOHisto::fillTuple(G4int i, const G4String& parname, G4String& x)
{
  if(verbose > 1) {
    G4cout << "fill tuple # " << i 
	   <<" with  parameter <" << parname << "> = " << x << G4endl; 
...
void nEXOHisto::setFileName(const G4String& nam) 
{
  histName = nam;
}
...
void nEXOHisto::setFileType(const G4String& nam) 
{
  histType = nam;
}
...
const G4String& nEXOHisto::FileType() const
{
  return histType;
}
